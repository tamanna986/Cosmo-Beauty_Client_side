...
const UpdateProducts = () => {
    ...
    const handleFormSubmit = (e) => {
        ...
        const updatedProduct = { photo, name, brandName, category, price, rating };
    ...
    return (
        <div className="my-10">
        <h1 className="text-3xl font-bold text-rose-900 text-center mt-10">Update Product: { productForUpdate.name}</h1>
                ...
                <div className="card-body ">
                    <div className="flex justify-center items-center">
                        ...
                        <input
                            ...
                            name="photo"
                            defaultValue={ productForUpdate.photo}
                    ...
                    <div className="flex justify-center items-center">
                        ...
                        <input
                            ...
                            name="brandName"
                            defaultValue={ productForUpdate.brandName}
                    ...
                    <div className="flex justify-center items-center">
                        ...
                        <select name="category" defaultValue={ productForUpdate.category} className="select select-bordered w-full ">
                    ...
                    <div className="flex justify-center items-center">
                        ...
                        <input type="text" placeholder="Price" name="price" defaultValue={ productForUpdate.price} required className="input input-bordered input-secondary w-full" />
                    </div>
                    ...
                    <div className="flex justify-center items-center">
                        ...
                        <input type="number" placeholder="Rating" name="rating" defaultValue={ productForUpdate.rating} required className="input input-bordered input-secondary w-full" />
                    </div>

                    <div className="form-control ">
                        <button className="btn  bg-rose-900 text-white ">Submit</button>
                    </div>
                </div>
